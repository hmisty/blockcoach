...
虽然契约文书（劳动合同）里可能会约定每天仅出卖8小时的自由，但是，资本的代言人 —— 老板（股东） —— 或者资本的代理人 —— CEO/总监 —— 却无时无刻不在绞尽脑汁琢磨如何占用你更多的时间，本质上，也就是更多地剥夺你的自由。
...
这个合格资产，需要能够长期存活几十年，不会消失或毁灭。并且能够有较高的CAGR预期。也就是兼具安全性和高增长。
